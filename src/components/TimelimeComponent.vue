<template>
  <div class="main-ws-sec">
    <div class="post-topbar">
      <textarea name="post_area" id="post_area" class="form-control">
何を考えていますか?</textarea
      >
      ...
      <div class="post-st">
        <ul>
          <li>
            <a class="active" href="#" title="Submit post data">送信</a>
          </li>
        </ul>
      </div>
      <!--post-st end-->
        ...
        <div class="post_topbar">
          <div class="usy-dt">
            ...
            <div class="usy-name">
              ...
              <span
                ><img src="../assets/images/clock.png" alt="" />05月07日</span
              >
            </div>
          </div>
          <div class="ed-opts">
          ...
          <ul class="like-com">
            <li>
              <a class="color-b2b2b2 cusror-poiter hover-color"
                ><i class="fa fa-heart"></i> いいね (25)</a
              >
            </li>
            <li>
              <a class="color-b2b2b2 cusror-poiter hover-color"
                ><i class="fa fa-comment-alt"></i> コメント (15)</a
              >
            </li>
          </ul>
        ...
        <div class="post_topbar">
          <div class="usy-dt">
            ...
            <div class="usy-name">
              ...
              <span
                ><img src="../assets/images/clock.png" alt="" />05月06日</span
              >
            </div>
          </div>
          <div class="ed-opts">
                ...
                <div class="comment-list">
                  ...
                  <div class="comment">
                    ...
                    <a href="#" title="" class="active"
                      ><i class="fa fa-reply-all"></i>返信</a
                    >
                  </div>
                </div>
                <!--comment-list end-->
